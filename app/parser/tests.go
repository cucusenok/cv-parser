...
const FULL_CV_ALEXEY = `Чуриков Алексей

Мужчина, 25 лет, родился 1 июня 1998

+7 (917) 3276278 alexeychurikov98@gmail.com — предпочитаемый способ связи

Проживает: Саратов Гражданство: Россия, есть разрешение на работу: Россия Не готов к переезду, не готов к командировкам
...
— Программист, разработчик Занятость: полная занятость График работы: полный день, удаленная работа Желательное время в пути до работы: не имеет значения

Опыт работы — 2 года

Май 2022 настоящее время 2 года

ООО "ОД" Outside Digital

Москва Информационные технологии, системная интеграция, интернет • Разработка программного обеспечения
...
Институт Юстиции, Юриспруденция
...
1. HTML5 + CSS3, SASS/LESS, Storybook

2. JavaScript - TypeScript

3. React, React & Redux, React Router, Next.js

4. Vue 2/3, Vuex, Vue Router, Nuxt.js

6. UI & UX Figma

Резюме обновлено 15 ноября 2023 в 13:12 7. Node.js, Express, git, webpack Мой Github: https://github.com/Alchurikov За время работы в компании я участвовал в разработке нескольких высокоэффективных веб-приложений для электронной коммерции, которые позволили оптимизировать работу и улучшить качество обслуживания клиентов. Я активно использовал такие технологии, как TypeScript, React, Redux, Nextjs, , Nestjs, Vue, Nuxt.js и Firebase.

Основные проекты включали создание ориентированного на клиента веб-приложения для электронной коммерции, в котором особое внимание уделялось удобному управлению аккаунтом и интуитивно понятному оформлению покупок. Реализованы такие передовые функции, как персонализированные рекомендации по товарам, покупка в один клик, интерактивные пользовательские панели, разработана комплексная система управления каталогом товаров, позволяющая легко добавлять, изменять и удалять товары. Реализованы функции динамической фильтрации и поиска для эффективного поиска товаров.

Мои усилия способствовали тесному сотрудничеству между различными командами, повышению удовлетворенности и вовлеченности клиентов, увеличению их удержания, оптимизации внутренних процессов и предоставлению ценной информации для принятия решений.

Чуриков Алексей • Резюме обновлено 15 ноября 2023 в 13:12`

const FULL_CV_VLADISLAV = `Владислав Распопин

Frontend developer

Telegram: @fixervlad Mail: fixervlad@gmail.com in: /in/vladislav-ra HYPERLINK "https://www.linkedin.com/in/vladislav-raspopin/"spopin/

Достижения:

• Занимался оптимизацией кода проекта, что позволило облегчить разработку и ускорить работу сайта на 5%.

• Реализовал функционал выгрузки и формирования технической информации в удобном формате, что позволило отстроиться от конкурентов и повысить количество входящих заявок на 3%;

• Занимался исправлением критических ошибок, что увеличило доступность элементов сайта до 95%; Ключевые навыки:

HTML5, CSS3, Bootstrap, JS, Typescript, React, Redux, Redux toolkit, Recharts, Apache Echarts, Next js, docker, linux

ОПЫТ РАБОТЫ:

2023.08 – now – Frontend Developer, Custommade (custommade, caserf, itvist.org)

• Исправил вёрстку сайтов заказчика, что позволило увеличить удержание посетителей в среднем на 10%;

• Занимался исправлением критических ошибок, что увеличило доступность элементов сайта до 95%;

• Готовил проект к миграции с php на vue3 с целью оптимизации и ускорения разаботки.

• Занимался рефакторингом существующего кода совместо с бэкенд разработчиком, что позволило уменьшить время запросов и прогрузку страниц на 50% Stack: HTML5, CSS3, Bootstrap, JS, jquery, docker.

2022.04 – 2023.08 – Frontend Developer, IntelPRO

• Реализовал функционал выгрузки и формирования технической информации в удобном формате, что позволило отстроиться от конкурентов и повысить количество входящих заявок на 3%;

• Добавил возможность сортировки метрик по цвету, перестроил отображение категорий, что также повлияло на удобство пользователей; • Исправил ошибку связанную с неправильной обработкой некоторых типов данных, чем уменьшил количество вылетов на 8%;

• Занимался оптимизацией кода проекта, что позволило облегчить разработку и ускорить работу сайта на 5%.

Stack: HTML5, CSS3, React, Redux, Typescript, JS, Ant design, Apache Echarts, Recharts.

2021.01 – 2022.04 – Frontend Developer, 12 people

• В проекте мобильной карточной игры полностью сделал главный экран, настройки и авторизацию;

• Оптимизировал работу некоторых страниц, что ускорило загрузку сайта на 25%;

• Полностью создавал весь frontend для сайта аренды квартир в Нижнем Новгороде, занимался интеграцией яндекс карт.

Stack: HTML5, CSS3, React, NextJS, Redux, Typescript, Bootstrap, vue3, docker.

2020.02 – 2021.01 – Frontend Developer, TipTop Games

• Исправил множество критических проблем при работе с интерфейсом, которые блокировали функции оплаты, регистрации, и поиска игр, что увеличило количество клиентов на 15%;
